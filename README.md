...
## 모델 및 파이프라인
### LayoutLMv2
- visual features, text tokens, bounding box를 활용하여 이미지 분석
- 단순 text 뿐만 아니라 text의 OCR 박스 좌표 간의 상대적인 거리를 추출하여 text 임베딩과 visual 임베딩에 각각 결합하여 transformer로 입력
...
### 최종 결과
![image](https://user-images.githubusercontent.com/64139953/217692101-ef2ca5b0-f1b4-4cd0-a74d-7956b4c82858.png)
